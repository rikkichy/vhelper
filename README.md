<p align="center">
  <img
    src="data/icons/hicolor/scalable/apps/com.vlauncher.app.svg"
    alt="VLauncher logo"
    width="160"
  />
</p>
...
<p align="center">
<img alt="GitHub License" src="https://img.shields.io/github/license/rikkichy/VLauncher?style=for-the-badge&labelColor=2D3142&color=B0D7FF">
</p>
...
> [!NOTE]
> This part is intended for developers who want to build VLauncher from source.

```bash
git clone https://github.com/rikkichy/VLauncher.git
```
```bash
cd VLauncher
```
